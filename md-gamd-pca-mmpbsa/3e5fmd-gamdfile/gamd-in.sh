...
#workfolder=`pwd`
#source ./commo
natoms=33872 ##the number of atoms in the system
natoms_max=33872 ##the number of atoms in the system
ntwx=1000    ##the steps to write the trajectory
ntwprt=1814 ##the number of  protein-ligand atoms
igamd=3     ##gamd
...
nstlim=9520000 ##the sum of ntcmd and nteb
map=:1-54
